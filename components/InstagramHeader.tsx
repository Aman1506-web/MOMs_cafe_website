...
>
  ...
  />
      ...
      <a
        ...
        className="inline-flex items-center justify-center gap-2 mt-6 bg-pink hover:bg-pink/90 text-black px-8 py-3 rounded-full font-semibold transition-colors border-2 border-brown/30 shadow-soft"
      >
