...
const OWNER_NUMBER = "919810317722";
...
export function ReserveClient() {
  ...
  const handleSend = () => {
    ...
    const message = [
      "Table reservation request at Ministry Of Masala:",
      `Name: ${form.name}`,
      `Phone: ${form.phone}`,
        ...
        <div className="grid gap-6 rounded-[28px] bg-white p-6 shadow-soft md:grid-cols-[1.1fr_0.9fr]">
          <div className="space-y-4">
            ...
            <p className="text-black/70">
              Book your spot at Ministry Of Masala. We&apos;ll confirm instantly over WhatsApp.
            </p>
          ...
          <div className="relative hidden overflow-hidden rounded-3xl bg-brown shadow-soft md:block">
            <Image
              src="https://images.unsplash.com/photo-1554118811-1e0d58224f24?w=1000&q=80&auto=format&fit=crop"
              alt="MOM - Ministry Of Masala restaurant interior in Old Rajinder Nagar Delhi"
              fill
            ...
            <div className="absolute bottom-4 left-4 right-4 rounded-2xl bg-white/15 p-4 text-amber-50 backdrop-blur">
              <p className="display text-xl font-extrabold">Dine-in at Old Rajinder Nagar</p>
              <p className="text-sm text-amber-100/80">
                Perfect spot for students, friends, and family dinners.
              </p>
            </div>
          </div>
        </div>
